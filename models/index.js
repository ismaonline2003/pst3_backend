...
db.proyecto = require("./proyecto.js")(sequelizeInstance, Sequelize, db.seccion, db.profesor);
...
db.author = require("./author.js")(sequelizeInstance, Sequelize, db.author);
db.radio_audio = require("./radio_audio.js")(sequelizeInstance, Sequelize, db.author);
db.emision_audio = require("./emision_audio.js")(sequelizeInstance, Sequelize, db.radio_audio);
db.suscripcion = require("./suscripcion.js")(sequelizeInstance, Sequelize, db.user);
db.radio_visualizacion = require("./radio_visualizacion.js")(sequelizeInstance, Sequelize);
